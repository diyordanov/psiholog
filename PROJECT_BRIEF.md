...
Това е дипломна работа по тема "Сигурност и криптография". Кодът трябва да е **изчистен, документиран на български в README**, и да следва принципите от Section 5 на този brief.
...
**Множество ключове от един алгоритъм:** допустимо (само warning, не блокировка). При подписване се ползва **най-новият активен ключ** от всеки алгоритъм — без допълнителен избор от потребителя (по-просто UX).
