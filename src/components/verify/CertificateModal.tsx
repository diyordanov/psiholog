  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-md rounded-xl bg-white shadow-xl flex flex-col max-h-[85vh]"
      >
        <div className="flex items-center justify-between border-b border-neutral-200 px-5 py-4 shrink-0">
          <h3 id="cert-modal-title" className="text-sm font-semibold text-neutral-800">Детайли на сертификата</h3>
          <button
            onClick={onClose}
