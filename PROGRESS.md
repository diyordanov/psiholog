...
Тема за заключението на дипломната работа.
...
**Future work (извън MVP scope, за заключението на дипломната):**
...
- [ ] Дипломна работа (текстов документ) — чака структура/шаблон от университета
...
- Структура/шаблон на университета за дипломната работа
...
- Root CA rotation: accepted risk за дипломна среда — future work преди production deployment
